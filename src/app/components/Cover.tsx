...
export default function Cover() {
    const introCube1 = 'https://res.cloudinary.com/drw8eqw3i/image/upload/v1690907491/Mercor/cover/intro-cube_1_fvcua7.svg';
    const interStair1 = 'https://res.cloudinary.com/drw8eqw3i/image/upload/v1690907468/Mercor/cover/intro-stairs_1_n79jql.svg';
    const introPhone = 'https://res.cloudinary.com/drw8eqw3i/image/upload/v1690907533/Mercor/cover/intro-phone_1_k8myrt.svg';
    const introCubes = 'https://res.cloudinary.com/drw8eqw3i/image/upload/v1690907564/Mercor/cover/intro-cubes_1_q92ilw.svg';
    const introPillar = 'https://res.cloudinary.com/drw8eqw3i/image/upload/v1690988607/Mercor/cover/intro-pillar_1_cqosra.svg';
